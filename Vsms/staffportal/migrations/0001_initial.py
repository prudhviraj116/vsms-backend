    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('1', 'Admin'), ('2', 'Staff'), ('3', 'Student')], default='Student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Image', models.ImageField(default='images/Default.jpg', upload_to='Images/studentimages/')),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('desgination', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='staffportal.staff_depatments')),
                ('userrole', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
